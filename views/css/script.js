...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function n(e, t) {
        for (var r, o, n, i, a = 0, h = parseFloat(e[0]), s = parseFloat(e[1]), l = h + "," + s + " ", f = e.length, g = (0.5 * t) / (0.5 * f - 1), p = 0; p < f - 2; p += 2) {
            if (((a += g), (n = parseFloat(e[p + 2])), (i = parseFloat(e[p + 3])), 0.999999 < a))
                for (o = 1 / (Math.floor(a) + 1), r = 1; 0.999999 < a; ) (l += (h + (n - h) * o * r).toFixed(2) + "," + (s + (i - s) * o * r).toFixed(2) + " "), a--, r++;
            (l += n + "," + i + " "), (h = n), (s = i);
        }
        return l;
    }
        ...
        return isNaN(t)
            ...
            : function (e) {
                  r(e),
                      (e[1] = (function (e, t) {
                          if (!t) return e;
                          for (var r, o = e.match(X) || [], n = o.length, i = "", a = "reverse" === t ? ((r = n - 1), -2) : ((r = (2 * (parseInt(t, 10) || 0) + 1 + 100 * n) % n), 2), h = 0; h < n; h += 2)
                              (i += o[r - 1] + "," + o[r] + " "), (r = (r + a) % n);
                          return i;
                      })(e[1], parseInt(t, 10)));
              };
              ...
              "rect" === b
                  ...
                  ? ((l = "circle" === b ? (i = a = w.r) * M : ((i = w.rx), (a = w.ry) * M)),
                    (r =
                        ...
                        (n = w.cy) +
                        " C" +
                        [o + i, n + l, o + (s = i * M), n + a, o, n + a, o - s, n + a, o - i, n + l, o - i, n, o - i, n - l, o - s, n - a, o, n - a, o + s, n - a, o + i, n - l, o + i, n].join(",") +
                        "z"))
                  : "line" === b
        ...
        for (var r, o, n, i, a, h, s, l, f, g, p, c, u = e.length, d = 0.2 * (t || 1); -1 < --u; ) {
            for (p = (o = e[u]).isSmooth = o.isSmooth || [0, 0, 0, 0], c = o.smoothData = o.smoothData || [0, 0, 0, 0], p.length = 4, l = o.length - 2, s = 6; s < l; s += 6)
                (n = o[s] - o[s - 2]),
                    ...
                    (f = y(i, n)),
                    (g = y(h, a)),
                    (r = Math.abs(f - g) < d) && ((c[s - 2] = f), (c[s + 2] = g), (c[s - 1] = W(n * n + i * i)), (c[s + 3] = W(a * a + h * h))),
                    p.push(r, r, 0, 0, r, r);
            o[l] === o[0] &&
                o[1 + l] === o[1] &&
                ((n = o[0] - o[l - 2]),
                ...
                (f = y(i, n)),
                (g = y(h, a)),
                Math.abs(f - g) < d && ((c[l - 2] = f), (c[2] = g), (c[l - 1] = W(n * n + i * i)), (c[3] = W(a * a + h * h)), (p[l - 2] = p[l - 1] = !0)));
        }
        return e;
    }
    function j(e) {
        ...
        re = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, r, o) {
                ...
                if (
                    ...
                    b && (this._addTween(this._origin, "x", this._origin.x, this._eOrigin.x), (a = this._addTween(this._origin, "y", this._origin.y, this._eOrigin.y))),
